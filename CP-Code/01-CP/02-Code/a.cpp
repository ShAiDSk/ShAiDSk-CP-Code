...
struct Help{
    ...
    template<typename dataType>
    dataType mod_add(dataType a, dataType b, dataType m){
        a = a % m;
        b = b % m; 
        return (((a + b) % m) + m) % m;
    }
    template<typename dataType>
    dataType mod_mul(dataType a, dataType b, dataType m){
        a = a % m;
        b = b % m;
        return (((a * b) % m) + m) % m;
    }
    template<typename dataType>
    dataType mod_sub(dataType a, dataType b, dataType m){
        a = a % m;
        b = b % m;
        return (((a - b) % m) + m) % m;
    }
    template<typename dataType>
    dataType mod_div(dataType a, dataType b, dataType m){
        a = a % m;
        b = b % m;
